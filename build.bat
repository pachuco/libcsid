...
popd
pushd src-orig
gcc -o ..\csidfullorig.exe  main.c tinywinmm.c libcsid-full.c %opts% %link% 2>   ..\errfullorig.log
gcc -o ..\csidlightorig.exe main.c tinywinmm.c libcsid-light.c %opts% %link% 2> ..\errlightorig.log
popd